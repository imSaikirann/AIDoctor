...
function getEncryptionKey() {
    ...
    if (!source) {
        throw new Error("Missing MEDICAL_RECORDS_ENCRYPTION_KEY or JWT_SECRET. Cannot encrypt medical records.");
    }
    return createHash("sha256").update(source).digest();
}
export function encryptMedicalRecordContent(plainText) {
...
export function decryptMedicalRecordContent(cipherText) {
